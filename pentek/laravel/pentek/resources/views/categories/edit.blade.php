...
<div class="container">
    ...
    <p class="mb-1">Ezen az oldalon tudsz kategóriát szerkeszteni. A bejegyzéseket úgy tudod hozzárendelni, ha a
        kategória szerkesztése után módosítod a bejegyzést, és ott bejelölöd ezt a kategóriát is.</p>
    <div class="mb-4">
    ...
    @if (Session::has('category-updated'))
        <div class="alert alert-success" role="alert">
            A(z) {{ Session::get('category-updated') }} nevű kategória sikeresen módosítva lett!
        </div>
    @endif
